...
public abstract class Initializer {
     ...
     */
    public <T extends TType> Assign<T> apply(Ops tf, Operand<T> in, Class<T> dtype) {
     ...
     */
    public abstract <T extends TType> Operand<T> initialize(Ops tf, Operand<TInt32> shape, Class<T> dtype);
}
